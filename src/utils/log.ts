...
export function warn(message: string) {
    console.warn(`${env.VITE_TITLE}:` + message);
}

export function error(message: string) {
    console.log(`%c${env.VITE_TITLE} throw error: ${message}`, "background: red;color: #fff;");
}

export function hello() {
    console.log(`%c 欢迎使用 Pangza Vue Admin`, helloStyle);
}